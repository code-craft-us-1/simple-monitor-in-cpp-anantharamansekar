...
// Function: PrintError
// Description: This function prints an error message to the console and creates a blinking effect to draw attention to the error.
// Parameters:
//   - const string& errorMessage: A constant reference to a string containing the error message to be displayed.
// Returns: void
...
// Description: This function checks if the provided temperature is within the acceptable range (95 to 102 degrees Fahrenheit).
// Parameters:
...
// Function: CheckPulse
// Description: This function checks if the provided pulse rate is within the acceptable range (60 to 100 beats per minute).
// Parameters:
...
// Function: CheckSPO2
// Description: This function checks if the provided oxygen saturation level (SPO2) is within the acceptable range (90% and above).
// Parameters:
...
//   - Returns false and prints an error message if the oxygen saturation level is below the acceptable range.
// Usage: Call this function with an oxygen saturation level value to verify if it is within the normal range.
...
// Function: vitalsOk
// Description: This function checks if all provided vital signs (temperature, pulse rate, and oxygen saturation) are within their respective acceptable ranges.
// Parameters:
//   - float temperature: The temperature value to be checked.
//   - float pulseRate: The pulse rate value to be checked.
//   - float spo2: The oxygen saturation level to be checked.
...
// Usage: Call this function with temperature, pulse rate, and oxygen saturation values to verify if all vital signs are within normal ranges.
